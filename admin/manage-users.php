...
$stmt = $pdo->prepare("SELECT * FROM users WHERE fullName LIKE :search OR email LIKE :search");
        ...
        <div class="container">
            ...
            <div class="container mt-5">
                ...
                <div class="input-group mb-3">
                    <input type="text" id="searchInput" class="form-control search-bar" placeholder="Search for users...">
