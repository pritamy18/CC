        ...
        <div class="container">
            ...
            <div class="container">
                ...
                <div class="search-bar d-flex">
                    <input type="text" class="form-control" id="searchInput" placeholder="Search for donors...">
                    <button class="btn btn-danger ml-2" id="searchButton">Search</button>
                </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody id="donorsTableBody">
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <td>$row[address]</td>
                            <td>$row[mobile]</td>
                            <td>$row[regRegularDonor]</td>
                            <td>$row[lastDonatedBlood]</td>
                          </tr>";
                          $index ++;  
                        }   
                ?>
            ...
            <script>
                ...
                function filterTable() {
                    ...
                    let rows = document.getElementById('donorsTableBody').getElementsByTagName('tr');
