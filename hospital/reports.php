            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['report_id']) && isset($_POST['action'])) {
                        ...
                        $updateSql = "UPDATE reports SET status = ? WHERE report_id = ?";
                    ...
                    $sql = "SELECT d.fullName, r.status, r.dr_id, r.report_id, r.created_at, d.phone, r.issue_type, r.description
                            FROM doctors d
                            INNER JOIN reports r ON d.dr_id = r.dr_id;";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            $buttonVisible = $row['status'] === 'Pending' ? '' : 'style="display:none;"';
                            ...
                            echo "<tr>
                                    ...
                                    <td>
                                        <form method='POST'>
                                            ...
                                            <button type='submit' name='action' value='approve' class='action-btn approve-btn' $buttonVisible>Approve</button>
                                            <button type='submit' name='action' value='reject' class='action-btn reject-btn' $buttonVisible>Reject</button>
                                        </form>
                                    </td>
                                  </tr>";
                        }
